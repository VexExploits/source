...
local library = {
    ...
    multiZindex = 200;
    toInvis = {};
    libColor = Color3.fromRGB(161,0,219);
...
local menu           = game:GetObjects("rbxassetid://17758625656")[1]
...
function library:addTab(name)
    ...
    newButton.MouseButton1Click:Connect(function()
        ...
        for i,v in next, library.tabbuttons do
            ...
            if state then
                library:Tween(v.element, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(161,0,219)})
                library:Tween(v.text, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(161,0,219)})
            else
